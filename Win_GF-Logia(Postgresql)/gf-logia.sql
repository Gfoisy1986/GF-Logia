...
INSERT INTO "job" ("id", "user", "jobname", "jobinfo", "jobrepport", "punchin", "punchout", "wo") VALUES
	(1, 'GFoisy', 'Maintenance', 'Maintenance:  changement huile + changement filtreur hydaulique', 'Maintenance:  fait (GF)', NULL, NULL, 1);
